...
function extractText(data){
  ...
  result = result.split("\n").filter(l => {
    ...
    if(/^I will search/i.test(t)) return false;
    if(/^Let me/i.test(t)) return false;
    if(/^I.ll gather/i.test(t)) return false;
    if(/^I.ll look/i.test(t)) return false;
    if(/^Searching/i.test(t)) return false;
    if(/^Voici toutes les/i.test(t)) return false;
    if(/^Maintenant le briefing/i.test(t)) return false;
    if(t === "---") return false;
    return true;
  }).join("\n").replace(/^\n+/, "");
  return result.trim();
...
async function sendMorningBriefing(){
  ...
  try{
    const res=await axios.post("https://api.anthropic.com/v1/messages",{
      ...
      messages:[{role:"user",content:"Tu es un analyste de trading. Recherche le prix du GOLD et DAX et le calendrier economique du " + today + ". Reponds en francais. Commence DIRECTEMENT par le briefing sans introduction. Format:\n\n📊 BRIEFING " + today.toUpperCase() + "\n\n━━━━━━━━━━━━━━━━━\n🥇 GOLD (XAU/USD)\n━━━━━━━━━━━━━━━━━\n💰 Prix : [prix reel]\n📈 Tendance : [HAUSSIER/BAISSIER/NEUTRE]\n🛡 Support : [niveau] | 🎯 Resistance : [niveau]\n⚡ Signal : [LONG/SHORT/NEUTRE]\n\n━━━━━━━━━━━━━━━━━\n🇩🇪 DAX (GER40)\n━━━━━━━━━━━━━━━━━\n💰 Prix : [prix reel]\n📈 Tendance : [HAUSSIER/BAISSIER/NEUTRE]\n🛡 Support : [niveau] | 🎯 Resistance : [niveau]\n⚡ Signal : [LONG/SHORT/NEUTRE]\n\n━━━━━━━━━━━━━━━━━\n📅 ANNONCES DU JOUR\n━━━━━━━━━━━━━━━━━\n[chaque annonce: 🔴/🟠/🟡 heure nom]\n⚡ Court terme : [impact]\n📆 Long terme : [impact]\n\n━━━━━━━━━━━━━━━━━\n📰 NEWS CLES\n━━━━━━━━━━━━━━━━━\n• [news 1]\n• [news 2]\n• [news 3]\n\n━━━━━━━━━━━━━━━━━\n🧠 STRATEGIE DU JOUR\n━━━━━━━━━━━━━━━━━\n[2 phrases]\n\n🤖 Anton Trading Bot"}]
